...
class CourseOfferingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create course_offering" do
    assert_difference('CourseOffering.count') do
      post course_offerings_url, params: { course_offering: { course_code: 'WAE', semester: '1', title: 'ttt', year: '2016' } }
    end
  ...
  test "should update course_offering" do
    patch course_offering_url(@course_offering), params: { course_offering: { course_code: 'WAE', semester: '1', title: @course_offering.title, year: @course_offering.year } }
